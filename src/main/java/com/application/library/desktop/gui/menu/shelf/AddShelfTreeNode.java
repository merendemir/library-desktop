...
@Component
public class AddShelfTreeNode extends DefaultMutableTreeNode implements SelectableTreeNode {
    private final ApplicationEventPublisher applicationEventPublisher;

    private static final MenuOptions menuOptions = MenuOptions.ADD_SHELF;

    public AddShelfTreeNode(ApplicationEventPublisher applicationEventPublisher) {
    ...
    public ImageIcon getImageIconPath() {
        return IconConstants.MENU_ADD_SHELF_ICON;
    }
