...
@Component
public class ShelvesTreeNode extends DefaultMutableTreeNode implements SelectableTreeNode {
    private final ApplicationEventPublisher applicationEventPublisher;

    private static final MenuOptions menuOptions = MenuOptions.SHELVES;

    public ShelvesTreeNode(ApplicationEventPublisher applicationEventPublisher) {
    ...
    public ImageIcon getImageIconPath() {
        return IconConstants.MENU_SHELVES_ICON;
    }
